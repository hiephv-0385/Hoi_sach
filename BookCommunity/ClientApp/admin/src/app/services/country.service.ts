...
export class CountryService {
    ...
    public getCountry(countryId: string): Observable<adminModel.Country> {
    ...
    public getCountries(params: adminModel.GetCountriesParams): Observable<adminModel.CountryListResponse> {
    ...
    public addCountry(user: adminModel.Country): Observable<adminModel.Country> {
    ...
    public updateCountry(countryId, payload: adminModel.Country): Observable<adminModel.Country> {
        const headers = new Headers();
        headers.set("X-XSRF-TOKEN", this.csrfToken);
        const url = `${this.countryUrl}/${countryId}`;
